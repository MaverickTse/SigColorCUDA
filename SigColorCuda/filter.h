...
BOOL func_save_start_s(FILTER *fp, int s, int e, void *editp);
BOOL func_save_end_s(FILTER *fp, void *editp);
BOOL func_is_saveframe_s(FILTER *fp, void *editp, int saveno, int frame, int fps, int edit_flag, int inter);
BOOL func_project_load_s(FILTER *fp, void *editp, void *data, int size);
BOOL func_project_save_s(FILTER *fp, void *editp, void *data, int *size);
BOOL func_modify_title_s(FILTER *fp, void *editp, int frame, LPSTR title, int max_title);
...
BOOL func_save_start_d(FILTER *fp, int s, int e, void *editp);
BOOL func_save_end_d(FILTER *fp, void *editp);
BOOL func_is_saveframe_d(FILTER *fp, void *editp, int saveno, int frame, int fps, int edit_flag, int inter);
BOOL func_project_load_d(FILTER *fp, void *editp, void *data, int size);
BOOL func_project_save_d(FILTER *fp, void *editp, void *data, int *size);
BOOL func_modify_title_d(FILTER *fp, void *editp, int frame, LPSTR title, int max_title);
